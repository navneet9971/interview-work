...
export default function Sidebar({
  ...
  return (
    <aside className="border-r-2 border-blue-200 p-4 text-sm bg-black-500 w-64 h-screen text-black">
      <h3 className="text-xl font-bold mb-4 text-blue-900">Flow Chart Maker</h3>
      {selectedNode ? (
        //settings panel
        <div>
          <h3 className="text-xl mb-2 text-blue-900">Update title</h3>
        ...
        <>
          ...
          <h3 className="text-xs mb-4 text-blue-900">Drag to new node on canvas</h3>          <div
